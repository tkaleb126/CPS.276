...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'ktomanovich';//this will be your WCC username
      $dbUsr = 'ktomanovich';//this will be your WCC username
      $dbPass = 't3lgjpbUmJHy91h';//this will be the password found in the video.
